  ...
  return (
    <div className={`w-full h-[4rem] flex ${Bg ? 'bg-teal-600' : 'bg-gradient-to-b from-teal-600'} fixed top-0 z-[99] px-[2rem] sm:px-[1rem] align-center justify-between`}>
        ...
        <ul className={`bg-teal-600 h-screen fixed right-0 top-0 pt-[4rem] md:p-0 w-[200px] text-center md:w-auto md:h-fit md:bg-transparent md:static md:my-auto md:flex ${navShow ? 'translate-x-0':'translate-x-[200px]' } transition ease-in-out duration-[1s] md:translate-x-0`}>
            <li className='md:mx-[25px] md:my-auto mx-[10px] my-[15px] text-slate-200 active:text-white focus:text-white hover:text-white transition-all duration-500 ease-in-out'><Link href='/destinations/' className='text-slate-500 active:text-white focus:text-white hover:text-white'>Destinations</Link></li>
            <li className='md:mx-[25px] md:my-auto mx-[10px] my-[15px] text-slate-200 active:text-white focus:text-white hover:text-white transition-all duration-500 ease-in-out'><Link href='/travel-blogs/' className='text-slate-500 active:text-white focus:text-white hover:text-white'>Travel Blogs</Link></li>
            <li className='md:mx-[25px] md:my-auto mx-[10px] my-[15px] text-slate-200 active:text-white focus:text-white hover:text-white transition-all duration-500 ease-in-out'><Link href='/your-blogs/' className='text-slate-500 active:text-white focus:text-white hover:text-white'>Your Blogs</Link></li>
